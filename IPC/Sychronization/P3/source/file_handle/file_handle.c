...
bool file_handle_read_copy_parameter(char *dir, char *p_input, char *p_out, char start_find, char stop_find)
{
    FILE *fp = NULL;
    fp = fopen(dir, "r");

    long file_size = file_handle_get_file_size(dir);
    long index = 0;
